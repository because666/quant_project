...
├── project/                    # 项目开发文件
│   ├── backend/                # 后端代码
│   │   ├── src/                # 源代码（API、数据库、核心模块）
│   │   ├── scripts/            # 工具脚本（数据下载、数据库初始化等）
│   │   ├── tests/              # 项目功能测试
│   │   ├── data/               # 项目运行数据
│   │   ├── data_archives/      # 分卷压缩数据包
│   │   └── models/             # 模型文件（项目运行用）
│   ├── frontend/               # 前端代码
│   ├── docs/                   # 开发规范文档
│   ├── .trae/                  # AI开发助手配置
│   └── 配置文件                # Dockerfile、Procfile等
├── thesis/                     # 学术论文文件
│   ├── docs/                   # 论文写作指南、协作方案、参考文献
│   └── ppt/                    # 组会PPT、演讲稿、图表素材
├── thesis_experiments/         # 论文实验相关文件
│   ├── scripts/                # 实验运行脚本
│   ├── src/                    # 共享模块副本（与project/backend/src/同步）
│   ├── data/                   # 实验结果数据
│   ├── figures/                # 论文图表
│   ├── models/                 # 实验模型文件
│   ├── tests/                  # 实验相关测试
│   ├── reference/              # 参考代码（Qlib等）
│   └── .trae/specs/            # 实验规格文档
└── .gitignore                  # Git忽略配置
```
